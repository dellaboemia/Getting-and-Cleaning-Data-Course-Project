...
## Read Data
This code reads the list of features, the activity labels, and the subjects, measurements, and activities for the test and training datasets.
...
The following code Selects the 66 mean and standard deviation variables from measurement data
```{r}
